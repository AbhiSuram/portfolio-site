    ...
    <footer className="footer--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/abhinav.surampudi.7/"
            ...
            <li>
              <a
                href="https://www.instagram.com/abhi.surampudi/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              ...
              >
                ...
                >
                <path
                    d="M12 2C6.48 2 2 6.48 2 12C2 16.42 5.07 20.17 9.26 21.5C9.81 21.58 10 21.27 10 21V19.14C6.73 19.78 6.14 17.73 6.14 17.73C5.68 16.54 5.03 16.22 5.03 16.22C4.12 15.62 5.1 15.63 5.1 15.63C6.1 15.7 6.63 16.68 6.63 16.68C7.5 18.18 8.97 17.75 9.54 17.5C9.62 16.85 9.87 16.41 10.14 16.15C7.39 15.88 4.5 14.92 4.5 10.62C4.5 9.39 4.97 8.4 5.73 7.64C5.61 7.38 5.2 6.21 5.82 4.66C5.82 4.66 6.76 4.37 10 6.29C10.91 6.03 11.88 5.9 12.86 5.9C13.84 5.9 14.81 6.03 15.72 6.29C18.96 4.37 19.9 4.66 19.9 4.66C20.52 6.21 20.11 7.38 19.99 7.64C20.75 8.4 21.22 9.39 21.22 10.62C21.22 14.94 18.31 15.87 15.54 16.13C15.93 16.5 16.28 17.2 16.28 18.26V21C16.28 21.27 16.47 21.59 17.02 21.5C21.21 20.17 24.28 16.42 24.28 12C24.28 6.48 19.52 2 14 2H12Z"
                    fill="black"
                />
                </svg>
              </a>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/abhi-suram/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Abhi</p>
      </div>
    </footer>
  );
}
